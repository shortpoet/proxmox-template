...
This [source repo](https://github.com/Aaron-K-T-Berry/packer-ubuntu-proxmox-template) has a packer template file to create a cloud init enabled ubuntu server 18.04 proxmox template.
